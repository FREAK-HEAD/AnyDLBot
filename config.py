...
class Config(object):
    ...
    CHAT_BASE_TOKEN = os.environ.get("CHAT_BASE_TOKEN", "4edd8db2-c21f-4337-ba95-c438bd698ea6")
    # get a token from @BotFather
    TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "1858646441:AAEoREOnphlRemDmBiteelt568D5-ASuoZ4")
